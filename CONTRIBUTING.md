...
2. **Register the op.** For simple unary ops, a one-liner in `src/pjrt_plugin/ops/unary_ops.mm` is enough (see [#12](https://github.com/danielpcox/applejax/pull/12) for an example):
